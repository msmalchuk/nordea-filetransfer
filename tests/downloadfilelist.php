...
$wsse = new WsseMiddleware($key_file, $cert_file);
...
$client->changeSoapLocation('https://filetransfer.nordea.com/services/CorporateFileService/sha2');

/** @var \Profit\Nordea\API\SoapTypes\DownloadFileListRequest $response */
$request = new \Profit\Nordea\API\SoapTypes\DownloadFileListRequest($config);
